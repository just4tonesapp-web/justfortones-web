...
export function testAView(container) {
  ...
  function showReport() {
    ...
    document.getElementById('ta-continue').addEventListener('click', () => {
      if (passed) {
        // TODO: navigate('/test-b')
        alert('Next: Test B (two-character tone pairs) — coming soon!')
      } else {
        // TODO: navigate('/practice-recognition')
        alert('Next: Tone Recognition Exercises — coming soon!')
      }
    })
  }
}
