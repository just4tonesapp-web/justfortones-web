...
export async function homeViewOld(container) {
  ...
  container.innerHTML = `
    <div class="app-shell">
      <div class="old-banner">
        ...
        <button class="old-banner-btn" id="goto-new">→ Try the new flow</button>
      </div>
  ...
  // Bind navigation
  document.getElementById('go-test-a').addEventListener('click', () => navigate('/old/test-a'))
  document.getElementById('go-test-b').addEventListener('click', () => navigate('/old/test-b'))
  document.getElementById('go-test-c').addEventListener('click', () => navigate('/old/test-c'))
  document.getElementById('go-test-d').addEventListener('click', () => navigate('/old/test-d'))
  document.getElementById('go-test-xyz').addEventListener('click', () => navigate('/old/test-xyz'))
  document.getElementById('go-test-y').addEventListener('click', () => navigate('/old/test-y'))
  document.getElementById('report-btn').addEventListener('click', () => navigate('/old/report'))
  ...
  document.getElementById('goto-new').addEventListener('click', () => { window.location.hash = '#/'; })
  ...
  style.textContent = `
    ...
    .old-banner-btn:hover { background: rgba(56,189,248,0.2); }
    .home-header {
      text-align: center;
      margin-bottom: 28px;
    }
