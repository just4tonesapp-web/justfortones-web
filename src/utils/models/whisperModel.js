...
export const CHAR_TONE_MAP = {
  ...
  // ── question-pool completion 2026-09-04: 31 Test-3 chars (extra pool,
  // June) were missing — every ASR model returned null on them ──
  '三': { base: 'san', tone: 1 }, '伞': { base: 'san', tone: 3 }, '散': { base: 'san', tone: 4 }, '七': { base: 'qi', tone: 1 },
  '八': { base: 'ba', tone: 1 }, '拔': { base: 'ba', tone: 2 }, '把': { base: 'ba', tone: 3 }, '爸': { base: 'ba', tone: 4 },
  '鸡': { base: 'ji', tone: 1 }, '高': { base: 'gao', tone: 1 }, '搞': { base: 'gao', tone: 3 }, '告': { base: 'gao', tone: 4 },
  '飞': { base: 'fei', tone: 1 }, '肥': { base: 'fei', tone: 2 }, '匪': { base: 'fei', tone: 3 }, '费': { base: 'fei', tone: 4 },
  '开': { base: 'kai', tone: 1 }, '听': { base: 'ting', tone: 1 }, '停': { base: 'ting', tone: 2 }, '挺': { base: 'ting', tone: 3 },
  '十': { base: 'shi', tone: 2 }, '千': { base: 'qian', tone: 1 }, '钱': { base: 'qian', tone: 2 }, '浅': { base: 'qian', tone: 3 },
  '欠': { base: 'qian', tone: 4 }, '妞': { base: 'niu', tone: 1 }, '牛': { base: 'niu', tone: 2 }, '扭': { base: 'niu', tone: 3 },
  '门': { base: 'men', tone: 2 }, '闷': { base: 'men', tone: 4 }, '白': { base: 'bai', tone: 2 }, '摆': { base: 'bai', tone: 3 },
  '拜': { base: 'bai', tone: 4 }, '偷': { base: 'tou', tone: 1 }, '头': { base: 'tou', tone: 2 }, '透': { base: 'tou', tone: 4 },
  '龙': { base: 'long', tone: 2 }, '拢': { base: 'long', tone: 3 }, '汪': { base: 'wang', tone: 1 }, '王': { base: 'wang', tone: 2 },
  '网': { base: 'wang', tone: 3 }, '忘': { base: 'wang', tone: 4 }, '屋': { base: 'wu', tone: 1 }, '无': { base: 'wu', tone: 2 },
  '五': { base: 'wu', tone: 3 }, '误': { base: 'wu', tone: 4 }, '究': { base: 'jiu', tone: 1 }, '九': { base: 'jiu', tone: 3 },
  '旧': { base: 'jiu', tone: 4 }, '收': { base: 'shou', tone: 1 }, '手': { base: 'shou', tone: 3 }, '瘦': { base: 'shou', tone: 4 },
  '迷': { base: 'mi', tone: 2 }, '米': { base: 'mi', tone: 3 }, '蜜': { base: 'mi', tone: 4 }, '捞': { base: 'lao', tone: 1 },
  '牢': { base: 'lao', tone: 2 }, '老': { base: 'lao', tone: 3 }, '涝': { base: 'lao', tone: 4 }, '雨': { base: 'yu', tone: 3 },
  '遇': { base: 'yu', tone: 4 }, '活': { base: 'huo', tone: 2 }, '火': { base: 'huo', tone: 3 }, '货': { base: 'huo', tone: 4 },
  '操': { base: 'cao', tone: 1 }, '草': { base: 'cao', tone: 3 }, '儿': { base: 'er', tone: 2 }, '耳': { base: 'er', tone: 3 },
  '二': { base: 'er', tone: 4 }, '溜': { base: 'liu', tone: 1 }, '流': { base: 'liu', tone: 2 }, '柳': { base: 'liu', tone: 3 },
  '六': { base: 'liu', tone: 4 }, '颠': { base: 'dian', tone: 1 }, '点': { base: 'dian', tone: 3 }, '电': { base: 'dian', tone: 4 },
  '哀': { base: 'ai', tone: 1 }, '挨': { base: 'ai', tone: 2 }, '矮': { base: 'ai', tone: 3 }, '爱': { base: 'ai', tone: 4 },
  '炉': { base: 'lu', tone: 2 }, '鲁': { base: 'lu', tone: 3 }, '路': { base: 'lu', tone: 4 }, '猜': { base: 'cai', tone: 1 },
  '才': { base: 'cai', tone: 2 }, '采': { base: 'cai', tone: 3 }, '菜': { base: 'cai', tone: 4 }, '快': { base: 'kuai', tone: 4 },
  '筷': { base: 'kuai', tone: 4 },
